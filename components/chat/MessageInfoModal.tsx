...
import { getEmail, parseTs } from "@/lib/utils";
import type { Message, Group, Contact } from "@/types";
...
export default function MessageInfoModal({ message, group, contacts, getPeerName, onClose }: MessageInfoModalProps) {
